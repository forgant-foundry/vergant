...
//
// [Patch] — a maintenance branch for a previously released version (e.g.
// "support/1.4.x"). Drives patch increments in isolation from the default line.
// Matched by [Config.PatchBranchRegEx].
//
...
//
// This identifier is embedded in dev version tags as the build ticket prefix
// (e.g. d1.4.0+acme.123.0).
//
// # Failure behaviour
//
// [ForName] returns an error for branch names that match none of the three
